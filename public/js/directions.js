const ors = new Openrouteservice.Directions({
  api_key: '5b3ce3597851110001cf6248c39a8ca2962b4022b0282306210393c7'
})

const directionsProfile = 'foot-walking'
// const directionsProfile = 'cycling-regular'


const getDirections = (params, response) => {
...
const getDistances = (params, response) => {
  let request = new XMLHttpRequest();
